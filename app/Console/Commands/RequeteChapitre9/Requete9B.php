...
class Requete9B extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:requete9B';
     ...
     * @var string
     */
    protected $description = 'Pour une ville donnée, informe s\'il est possible de trouver toutes les communes voisines à 20 km près';
